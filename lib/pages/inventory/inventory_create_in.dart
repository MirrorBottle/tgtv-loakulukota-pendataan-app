...
class InventoryCreateInScreen extends StatefulWidget {
  const InventoryCreateInScreen({Key? key}) : super(key: key);

  @override
  _InventoryCreateInScreenState createState() =>
      _InventoryCreateInScreenState();
}

class _InventoryCreateInScreenState extends State<InventoryCreateInScreen> {
  ...
  Future<void> _onSaveSubmit() async {
    awesome_dialog.AwesomeDialog(
            ...
            desc: 'Pastikan daftar barang masuk sudah benar!',
            btnOkText: "Ya",
            btnOkOnPress: () async {
              EasyLoading.show(
                  status: 'Mohon Ditunggu',
                  maskType: EasyLoadingMaskType.black);
              await _inventoryLogService.create(type: 2, stocks: _stocks, note: _note.text);
              EasyLoading.dismiss();
              awesome_dialog.AwesomeDialog(
                      context: context,
                      animType: awesome_dialog.AnimType.BOTTOMSLIDE,
                      ...
                      showCloseIcon: true,
                      title: 'Berhasil',
                      desc: 'Berhasil Verifikasi Barang Masuk!',
                      btnOkOnPress: () {
